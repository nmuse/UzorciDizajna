...
using nmuse_zadaca_3.ChainOfResponsibilityObrade;
using System;
...
namespace nmuse_zadaca_3.FactoryMethod
{
    class UcitajDogadaje : IProduct
    {
        public void ucitavanjeDatoteke(string datotekaZaUcitavanje)
        {
            ...
            {
                Console.WriteLine("Neispravna datoteka dogadaja");
            }
            ...
            foreach (String linija in linije)
            {
                ...
                if (noviDogadaj == null) continue;
                int rezultatObrade = obradiDogadaj(noviDogadaj);
                if (rezultatObrade == 0) continue;
                ...
                {
                    if (u.Broj == noviDogadaj.Broj)
                    {
                        u.dodajDijete(noviDogadaj);
                    }
                }
        ...
        private int obradiDogadaj(Dogadaj noviDogadaj)
        {
            ObradaGola obradaGola = new ObradaGola();
            ObradaKartona obradaKartona = new ObradaKartona();
            ObradaZamjeneIgraca obradaZamjeneIgraca = new ObradaZamjeneIgraca();
            obradaGola.postaviSljedeciHandler(obradaKartona).postaviSljedeciHandler(obradaZamjeneIgraca);
            int i = -1;
            switch(noviDogadaj.Vrsta)
            {
                case 1:
                case 2:
                case 3:
                ...
                case 11:
                case 20:
                    i = obradaGola.obradiDogadaj(noviDogadaj);
                    break;
            }
            return i;
        }
        ...
        private static bool provjeriZamjenuIKlubZaZamjenu(string linija, Dogadaj noviDogadaj)
        {
            ...
            if (noviDogadaj.Zamjena.Klub != noviDogadaj.Klub.Kratica)
            {
        ...
        private static bool provjeriIgracaIKlubZaZamjenu(string linija, Dogadaj noviDogadaj)
        {
            ...
            if (noviDogadaj.Igrac.Klub != noviDogadaj.Klub.Kratica)
            {
